...
<?
	//ENERO
	$mes = 1;
	$descri = estado($delcod,$empcod,$año,$mes);
	if ($descri == "PAGO") {
	print ("<td width=81><div align=center><font face=Verdana size=1><a href=pagos.php?empcod=".$empcod."&ano=".$año."&mes=".$mes.">".$descri."</font></div></td>");
	}
	if ($descri == "ACUER.") {
	print ("<td width=81><div align=center><font face=Verdana size=1><a href=acuerdos.php?empcod=".$empcod."&ano=".$año."&mes=".$mes.">".$descri."</font></div></td>");
	}
	if ($descri == "P.DIF.") {
	print ("<td width=81><div align=center><font face=Verdana size=1><a href=pagosAnte.php?empcod=".$empcod."&ano=".$año."&mes=".$mes.">".$descri."</font></div></td>");
	}
...
<table width="1027" border="0">
  <tr>
    <th width="502" scope="row"><div align="left"><b><font face="Verdana" size="2">
      <input name="back3" type="submit" id="back3" value="VOLVER" onclick= "location.href='elige_cuenta.php'"/>
    </font></b></div></th>
