...
<table width="1019" border="1">
  <tr>
    <th width="367" scope="row"><div align="right" class="Estilo7">RECARGO</div></th>
    <th width="463" scope="row">&nbsp;</th>
    <th width="175" class="Estilo7" scope="row"><? print($row4['recarg']); ?></th>
  </tr>
</table>
<table width="1019" border="1">
  <tr>
    <th width="367" scope="row"><div align="right" class="Estilo7">TOTAL DEPOSITADO </div></th>
    <th width="463" scope="row">&nbsp;</th>
